...
.method private static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p0, p1, v1, v2, v0}, La7/v;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method private static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct/range {v2 .. v7}, La7/v$b;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {p0}, La7/v;->d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v0, v1}, La7/v;->e(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-static {p0, v0}, La7/v;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static final d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    new-instance v1, La7/v$a;

    invoke-direct {v1, p0, v0}, La7/v$a;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V
