...
.method protected final p0(ILandroid/os/Parcel;)Z
    ...
    instance-of v0, p2, Lj6/u0;

    if-eqz v0, :cond_2

    move-object v1, p2

    check-cast v1, Lj6/u0;

    goto :goto_0

    :cond_2
    new-instance v1, Lj6/t0;

    invoke-direct {v1, p1}, Lj6/t0;-><init>(Landroid/os/IBinder;)V

    :goto_0
    invoke-interface {p0, v1}, Lj6/s0;->E7(Lj6/u0;)V
    ...
    invoke-direct {v1, p2}, Lj6/t0;-><init>(Landroid/os/IBinder;)V

    :goto_1
    invoke-interface {p0, p1, v1}, Lj6/s0;->T4(Landroid/os/Bundle;Lj6/u0;)V
