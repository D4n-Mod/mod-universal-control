...
.method private D(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lb6/g;
...
.method private u(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lb6/g;

    move-result-object v1

    sget v2, Ll5/b;->h:I

    invoke-static {p1, v2}, Ls5/a;->c(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILb6/g;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->v(Landroid/widget/AutoCompleteTextView;I[[ILb6/g;)V
...
.method private v(Landroid/widget/AutoCompleteTextView;I[[ILb6/g;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Ls5/a;->f(IIF)I
    ...
    invoke-static {p1, p3}, Landroidx/core/view/t;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, Lb6/g;->C()Lb6/k;

    move-result-object v4

    invoke-direct {v0, v4}, Lb6/g;-><init>(Lb6/k;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Lb6/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Landroidx/core/view/t;->D(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroidx/core/view/t;->C(Landroid/view/View;)I
    ...
    invoke-static {p1, p2}, Landroidx/core/view/t;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Landroidx/core/view/t;->t0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private w(Landroid/widget/AutoCompleteTextView;I[[ILb6/g;)V
    .locals 7

    sget v0, Ll5/b;->l:I

    invoke-static {p1, v0}, Ls5/a;->c(Landroid/view/View;I)I
    ...
    invoke-static {p2, v0, v2}, Ls5/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Lb6/g;->W(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Lb6/g;->setTint(I)V
    ...
    new-instance p3, Lb6/g;

    invoke-virtual {p4}, Lb6/g;->C()Lb6/k;

    move-result-object v0

    invoke-direct {p3, v0}, Lb6/g;-><init>(Lb6/k;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Lb6/g;->setTint(I)V
...
.method private z(FFFI)Lb6/g;
    .locals 1

    invoke-static {}, Lb6/k;->a()Lb6/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lb6/k$b;->z(F)Lb6/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Lb6/k$b;->D(F)Lb6/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lb6/k$b;->r(F)Lb6/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, Lb6/k$b;->v(F)Lb6/k$b;
    ...
    invoke-static {p2, p3}, Lb6/g;->m(Landroid/content/Context;F)Lb6/g;

    move-result-object p2

    invoke-virtual {p2, p1}, Lb6/g;->setShapeAppearanceModel(Lb6/k;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Lb6/g;->Y(IIII)V
...
.method a()V
    ...
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lb6/g;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Lb6/g;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lb6/g;
