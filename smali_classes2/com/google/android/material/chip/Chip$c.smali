...
.method protected M(Ll0/c;)V
    ...
    invoke-virtual {p1, v0}, Ll0/c;->V(Z)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Ll0/c;->X(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Ll0/c;->s0(Ljava/lang/CharSequence;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p1, v0}, Ll0/c;->b0(Ljava/lang/CharSequence;)V

    :goto_3
    return-void
.end method

.method protected N(ILl0/c;)V
    .locals 6
    ...
    :goto_0
    invoke-virtual {p2, p1}, Ll0/c;->b0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Ll0/c;->T(Landroid/graphics/Rect;)V

    sget-object p1, Ll0/c$a;->e:Ll0/c$a;

    invoke-virtual {p2, p1}, Ll0/c;->b(Ll0/c$a;)V
    ...
    invoke-virtual {p2, p1}, Ll0/c;->c0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v0}, Ll0/c;->b0(Ljava/lang/CharSequence;)V
