...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/b$a;->p0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public B0()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->B0()Landroid/support/v4/media/MediaMetadataCompat;
...
.method public a(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/b;->R3(Landroid/support/v4/media/session/a;)V
...
.method public b()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->l2()Landroid/app/PendingIntent;
...
.method public d(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/b;->B1(Landroid/support/v4/media/session/a;)V
...
.method public z()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->z()Landroid/support/v4/media/session/PlaybackStateCompat;
