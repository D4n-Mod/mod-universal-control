...
# instance fields
.field private G0:Landroidx/vectordrawable/graphics/drawable/h$h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/vectordrawable/graphics/drawable/h;->O0:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->K0:Z

    const/16 v0, 0x9

    new-array v0, v0, [F

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->M0:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->N0:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->G0:Landroidx/vectordrawable/graphics/drawable/h$h;
...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/h$h;)V
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->G0:Landroidx/vectordrawable/graphics/drawable/h$h;

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->H0:Landroid/graphics/PorterDuffColorFilter;
    ...
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->H0:Landroid/graphics/PorterDuffColorFilter;
...
.method public static b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/vectordrawable/graphics/drawable/h;
    ...
    invoke-static {p0, p1, p2}, La0/f;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    iput-object p0, v0, Landroidx/vectordrawable/graphics/drawable/g;->F0:Landroid/graphics/drawable/Drawable;

    new-instance p0, Landroidx/vectordrawable/graphics/drawable/h$i;

    iget-object p1, v0, Landroidx/vectordrawable/graphics/drawable/g;->F0:Landroid/graphics/drawable/Drawable;
...
.method private e(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->G0:Landroidx/vectordrawable/graphics/drawable/h$h;
    ...
    iget-object v6, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lq/a;
    ...
    iget-object v7, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lq/a;
...
.method private i(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v2, v3, v4}, La0/g;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-static {p1, p2, p3, v2, v3}, La0/g;->c(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, v3, p3, v2}, La0/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v2, p3, v0}, La0/g;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    iget-object p2, v1, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lq/a;
...
.method public canApplyTheme()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g;->F0:Landroid/graphics/drawable/Drawable;
...
.method d(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroidx/vectordrawable/graphics/drawable/h$g;->p:Lq/a;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->N0:Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->I0:Landroid/graphics/ColorFilter;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->M0:Landroid/graphics/Matrix;

    invoke-virtual {p1, v1}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->M0:Landroid/graphics/Matrix;

    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F
    ...
    iget-object v3, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F
    ...
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->L0:[F
    ...
    :cond_4
    iget-object v4, p0, Landroidx/vectordrawable/graphics/drawable/h;->N0:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/vectordrawable/graphics/drawable/h;->N0:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->G0:Landroidx/vectordrawable/graphics/drawable/h$h;

    invoke-virtual {v2, v1, v3}, Landroidx/vectordrawable/graphics/drawable/h$h;->c(II)V

    iget-boolean v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->K0:Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->G0:Landroidx/vectordrawable/graphics/drawable/h$h;
    ...
    iget-object v2, p0, Landroidx/vectordrawable/graphics/drawable/h;->N0:Landroid/graphics/Rect;
...
.method public getColorFilter()Landroid/graphics/ColorFilter;
    ...
    invoke-static {v0}, Lc0/a;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/g;->F0:Landroid/graphics/drawable/Drawable;
...
.method h(Z)V
    ...
    iput-boolean p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->K0:Z
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p4, p3, v1}, La0/g;->k(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    iget-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->H0:Landroid/graphics/PorterDuffColorFilter;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->J0:Z
    ...
    iput-boolean v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->J0:Z
...
.method protected onStateChange([I)Z
    ...
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/h;->H0:Landroid/graphics/PorterDuffColorFilter;
...
.method public setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/vectordrawable/graphics/drawable/h;->I0:Landroid/graphics/ColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/h;->H0:Landroid/graphics/PorterDuffColorFilter;
