...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p1, Landroidx/mediarouter/app/i$f;->t:Lt0/n$i;

    invoke-virtual {p1, v0}, Landroidx/mediarouter/app/i$h$g;->S(Lt0/n$i;)Z
    ...
    iget-object v1, v1, Landroidx/mediarouter/app/i$f;->t:Lt0/n$i;

    invoke-virtual {v1}, Lt0/n$i;->y()Z
    ...
    iget-object v3, v3, Landroidx/mediarouter/app/i;->H0:Lt0/n;

    iget-object v2, v2, Landroidx/mediarouter/app/i$f;->t:Lt0/n$i;

    if-eqz p1, :cond_0

    invoke-virtual {v3, v2}, Lt0/n;->c(Lt0/n$i;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v3, v2}, Lt0/n;->p(Lt0/n$i;)V
    ...
    invoke-virtual {v2}, Lt0/n$i;->l()Ljava/util/List;
    ...
    invoke-virtual {v1, v0, p1}, Landroidx/mediarouter/app/i$h;->G(Lt0/n$i;Z)V
