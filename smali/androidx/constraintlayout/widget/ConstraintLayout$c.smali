...
.method public final b(Lu/e;Lv/b$a;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->a0()Z
    ...
    :cond_1
    invoke-virtual/range {p1 .. p1}, Lu/e;->I()Lu/e;
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->q()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->f0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->P()I
    ...
    invoke-static {v9, v11}, Lu/j;->b(II)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->n()I

    move-result v9

    if-ne v8, v9, :cond_1a

    invoke-virtual/range {p1 .. p1}, Lu/e;->d0()Z

    move-result v8

    if-nez v8, :cond_1a

    invoke-virtual/range {p1 .. p1}, Lu/e;->A()I
    ...
    invoke-virtual/range {p1 .. p1}, Lu/e;->B()I
    ...
    :goto_10
    sget-object v11, Lu/e$b;->I0:Lu/e$b;

    if-eq v4, v11, :cond_1e

    sget-object v12, Lu/e$b;->F0:Lu/e$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/l;->o(Lu/k;II)V
    ...
    :goto_18
    invoke-virtual {v1, v6, v7}, Lu/e;->F0(II)V
    ...
    invoke-static {v6, v0}, Lu/j;->b(II)Z
