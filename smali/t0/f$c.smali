...
.field final synthetic o:Lt0/f;


# direct methods
.method constructor <init>(Lt0/f;Landroid/media/MediaRouter2$RoutingController;Ljava/lang/String;)V
    .locals 1

    iput-object p1, p0, Lt0/f$c;->o:Lt0/f;
    ...
    iput-object p1, p0, Lt0/f$c;->j:Landroid/util/SparseArray;
    ...
    iput-object p1, p0, Lt0/f$c;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Lt0/g;

    invoke-direct {p1, p0}, Lt0/g;-><init>(Lt0/f$c;)V

    iput-object p1, p0, Lt0/f$c;->m:Ljava/lang/Runnable;

    const/4 p1, -0x1

    iput p1, p0, Lt0/f$c;->n:I

    iput-object p2, p0, Lt0/f$c;->g:Landroid/media/MediaRouter2$RoutingController;

    iput-object p3, p0, Lt0/f$c;->f:Ljava/lang/String;

    invoke-static {p2}, Lt0/f;->B(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Messenger;

    move-result-object p1

    iput-object p1, p0, Lt0/f$c;->h:Landroid/os/Messenger;
    ...
    new-instance p2, Lt0/f$c$a;

    invoke-direct {p2, p0}, Lt0/f$c$a;-><init>(Lt0/f$c;)V

    invoke-direct {p1, p2}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    :goto_0
    iput-object p1, p0, Lt0/f$c;->i:Landroid/os/Messenger;
    ...
    iput-object p1, p0, Lt0/f$c;->k:Landroid/os/Handler;

    return-void
.end method

.method public static synthetic q(Lt0/f$c;)V
    .locals 0

    invoke-direct {p0}, Lt0/f$c;->r()V
...
.method private s()V
    ...
    iget-object v0, p0, Lt0/f$c;->k:Landroid/os/Handler;

    iget-object v1, p0, Lt0/f$c;->m:Ljava/lang/Runnable;
...
.method public d()V
    ...
    iget-object v0, p0, Lt0/f$c;->g:Landroid/media/MediaRouter2$RoutingController;
...
.method public i(I)V
    ...
    iget-object p1, p0, Lt0/f$c;->g:Landroid/media/MediaRouter2$RoutingController;
...
.method public m(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, Lt0/f$c;->o:Lt0/f;

    invoke-virtual {v1, p1}, Lt0/f;->C(Ljava/lang/String;)Landroid/media/MediaRoute2Info;
...
.method public o(Ljava/util/List;)V
    ...
    :cond_1
    iget-object p1, p0, Lt0/f$c;->o:Lt0/f;
...
.method t(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Lt0/f$c;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, p0, Lt0/f$c;->i:Landroid/os/Messenger;

    iput-object p1, v1, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object p1, p0, Lt0/f$c;->h:Landroid/os/Messenger;
