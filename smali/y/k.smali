...
# direct methods
.method constructor <init>(Ly/j$e;)V
    .locals 11
    ...
    iput-object v0, p0, Ly/k;->e:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Ly/k;->f:Landroid/os/Bundle;

    iput-object p1, p0, Ly/k;->b:Ly/j$e;
    ...
    iget-object v3, p1, Ly/j$e;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Ly/j$e;->I:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Ly/k;->a:Landroid/app/Notification$Builder;

    iget-object v2, p1, Ly/j$e;->P:Landroid/app/Notification;

    iget-object v3, p0, Ly/k;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Ly/j$e;->h:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Ly/j$e;->d:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Ly/j$e;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Ly/j$e;->j:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Ly/j$e;->f:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Ly/j$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Ly/j$e;->i:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Ly/j$e;->k:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Ly/j$e;->r:I

    iget v9, p1, Ly/j$e;->s:I

    iget-boolean v10, p1, Ly/j$e;->t:Z
    ...
    iget-object v4, p0, Ly/k;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Ly/k;->a:Landroid/app/Notification$Builder;

    iget-object v8, p1, Ly/j$e;->p:Ljava/lang/CharSequence;
    ...
    check-cast v8, Ly/j$a;

    invoke-direct {p0, v8}, Ly/k;->b(Ly/j$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Ly/j$e;->B:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Ly/k;->f:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Ly/j$e;->x:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Ly/k;->f:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Ly/j$e;->u:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Ly/j$e;->w:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Ly/j$e;->F:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ly/k;->c:Landroid/widget/RemoteViews;

    iget-object v0, p1, Ly/j$e;->G:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ly/k;->d:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Ly/k;->a:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Ly/j$e;->m:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    if-ge v0, v3, :cond_d

    iget-object v8, p1, Ly/j$e;->R:Ljava/util/ArrayList;
    ...
    iget-object v9, p1, Ly/j$e;->R:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Ly/j$e;->R:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v0, p1, Ly/j$e;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ly/k;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Ly/j$e;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Ly/j$e;->c()Landroid/os/Bundle;
    ...
    :goto_8
    iget-object v9, p1, Ly/j$e;->c:Ljava/util/ArrayList;
    ...
    iget-object v10, p1, Ly/j$e;->c:Ljava/util/ArrayList;

    invoke-virtual {v10, v8}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Ly/j$a;

    invoke-static {v10}, Ly/l;->b(Ly/j$a;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Ly/k;->f:Landroid/os/Bundle;
    ...
    iget-object v4, p1, Ly/j$e;->B:Landroid/os/Bundle;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Ly/j$e;->q:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Ly/j$e;->F:Landroid/widget/RemoteViews;
    ...
    :cond_13
    iget-object v3, p1, Ly/j$e;->G:Landroid/widget/RemoteViews;
    ...
    :cond_14
    iget-object v3, p1, Ly/j$e;->H:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p1, Ly/j$e;->O:Ly/j$d;

    invoke-static {v7}, Ly/j$d;->a(Ly/j$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_18
    iget-boolean p1, p1, Ly/j$e;->Q:Z

    if-eqz p1, :cond_1b

    iget-object p1, p0, Ly/k;->b:Ly/j$e;

    iget-boolean p1, p1, Ly/j$e;->v:Z
    ...
    :goto_9
    iget-object p1, p0, Ly/k;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Ly/k;->a:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Ly/j$e;->u:Ljava/lang/String;
...
.method private b(Ly/j$a;)V
    ...
    invoke-virtual {p1}, Ly/j$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, Ly/j$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Ly/j$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, Ly/j$a;->f()[Ly/n;
    ...
    invoke-static {v1}, Ly/n;->b([Ly/n;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Ly/j$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Ly/k;->e:Ljava/util/List;

    iget-object v1, p0, Ly/k;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Ly/l;->f(Landroid/app/Notification$Builder;Ly/j$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Ly/k;->b:Ly/j$e;

    iget-object v0, v0, Ly/j$e;->o:Ly/j$f;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Ly/j$f;->b(Ly/i;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Ly/j$f;->d(Ly/i;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Ly/k;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Ly/k;->b:Ly/j$e;

    iget-object v1, v1, Ly/j$e;->F:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Ly/j$f;->c(Ly/i;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Ly/k;->b:Ly/j$e;

    iget-object v4, v4, Ly/j$e;->o:Ly/j$f;

    invoke-virtual {v4, p0}, Ly/j$f;->e(Ly/i;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Ly/j;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Ly/j$f;->a(Landroid/os/Bundle;)V
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Ly/k;->e(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Ly/k;->f:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Ly/k;->c:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Ly/k;->d:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Ly/k;->h:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Ly/l;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Ly/j;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, Ly/k;->e:Ljava/util/List;

    invoke-static {v1}, Ly/l;->a(Ljava/util/List;)Landroid/util/SparseArray;
