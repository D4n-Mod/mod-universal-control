...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg4/j;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lg4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lg4/j;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static c(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lg4/b;->H(I)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lq4/b;->e(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {p0}, Lg4/k;->a(Landroid/content/Context;)Lg4/k;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Lg4/k;->f(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lg4/k;->f(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lg4/j;->b:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lg4/j;->b:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lg4/j;->b:Z

    if-nez p0, :cond_3

    invoke-static {}, Lo4/j;->c()Z
...
.method public static g(Landroid/content/Context;I)I
    ...
    sget-object v0, Lg4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/b0;->b(Landroid/content/Context;)I
    ...
    :cond_2
    :goto_1
    invoke-static {p0}, Lo4/j;->f(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_3

    invoke-static {p0}, Lo4/j;->g(Landroid/content/Context;)Z
    ...
    :goto_2
    invoke-static {p0, v0, p1}, Lg4/j;->l(Landroid/content/Context;ZI)I
...
.method public static h(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lg4/j;->m(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static k(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lo4/s;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method private static l(Landroid/content/Context;ZI)I
    ...
    :goto_0
    invoke-static {v3}, Lcom/google/android/gms/common/internal/l;->a(Z)V
    ...
    invoke-static {v8, v1}, Lg4/k;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0, v1}, Lg4/k;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lo4/v;->a(I)I

    move-result p0

    invoke-static {p2}, Lo4/v;->a(I)I
...
.method static m(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lg4/j;->i(Landroid/content/Context;)Z
