...
.method constructor <init>(I)V
    ...
    iput p1, p0, Lf/e$s;->a:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Lf/e$s;->q:Z
...
.method a(Landroidx/appcompat/view/menu/j$a;)Landroidx/appcompat/view/menu/k;
    ...
    iget-object v0, p0, Lf/e$s;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_0
    iget-object v0, p0, Lf/e$s;->k:Landroidx/appcompat/view/menu/c;

    if-nez v0, :cond_1

    new-instance v0, Landroidx/appcompat/view/menu/c;

    iget-object v1, p0, Lf/e$s;->l:Landroid/content/Context;

    sget v2, Le/g;->j:I

    invoke-direct {v0, v1, v2}, Landroidx/appcompat/view/menu/c;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lf/e$s;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/c;->g(Landroidx/appcompat/view/menu/j$a;)V

    iget-object p1, p0, Lf/e$s;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_1
    iget-object p1, p0, Lf/e$s;->k:Landroidx/appcompat/view/menu/c;

    iget-object v0, p0, Lf/e$s;->g:Landroid/view/ViewGroup;
...
.method public b()Z
    ...
    iget-object v0, p0, Lf/e$s;->h:Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Lf/e$s;->i:Landroid/view/View;
...
.method c(Landroidx/appcompat/view/menu/e;)V
    ...
    iget-object v1, p0, Lf/e$s;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/e;->O(Landroidx/appcompat/view/menu/j;)V

    :cond_1
    iput-object p1, p0, Lf/e$s;->j:Landroidx/appcompat/view/menu/e;
...
.method d(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lf/e$s;->l:Landroid/content/Context;
