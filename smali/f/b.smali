...
.method public F()Lf/d;
    .locals 1

    iget-object v0, p0, Lf/b;->V0:Lf/d;
    ...
    iput-object v0, p0, Lf/b;->V0:Lf/d;
...
.method public H(Ly/p;)V
    .locals 0

    invoke-virtual {p1, p0}, Ly/p;->d(Landroid/app/Activity;)Ly/p;
...
.method public L()Z
    ...
    invoke-virtual {p0}, Lf/b;->k()Landroid/content/Intent;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Lf/b;->O(Landroid/content/Intent;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p0}, Ly/p;->g(Landroid/content/Context;)Ly/p;

    move-result-object v0

    invoke-virtual {p0, v0}, Lf/b;->H(Ly/p;)V

    invoke-virtual {p0, v0}, Lf/b;->J(Ly/p;)V

    invoke-virtual {v0}, Ly/p;->h()V

    :try_start_0
    invoke-static {p0}, Ly/a;->k(Landroid/app/Activity;)V
    :try_end_0
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lf/b;->N(Landroid/content/Intent;)V
...
.method public N(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Ly/h;->e(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public O(Landroid/content/Intent;)Z
    ...
    invoke-static {p0, p1}, Ly/h;->f(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Lf/b;->W0:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Lf/b;->W0:Landroid/content/res/Resources;
...
.method public k()Landroid/content/Intent;
    ...
    invoke-static {p0}, Ly/h;->a(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, p0, Lf/b;->W0:Landroid/content/res/Resources;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0, p2}, Lf/b;->M(Landroid/view/KeyEvent;)Z
