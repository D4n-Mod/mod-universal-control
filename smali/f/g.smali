...
.field private static final e:Lq/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lq/g<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lf/g;->b:[Ljava/lang/Class;
    ...
    sput-object v1, Lf/g;->d:[Ljava/lang/String;

    new-instance v0, Lq/g;

    invoke-direct {v0}, Lq/g;-><init>()V

    sput-object v0, Lf/g;->e:Lq/g;
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/t;->I(Landroid/view/View;)Z
    ...
    invoke-direct {v1, p1, v0}, Lf/g$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method private r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object p3, Lf/g;->b:[Ljava/lang/Class;
    ...
    iget-object p1, p0, Lf/g;->a:[Ljava/lang/Object;
...
.method private s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, Lf/g;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lf/g;->d:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Lf/g;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Lf/g;->r(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, Lf/g;->a:[Ljava/lang/Object;
...
.method final q(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Lf/g;->t(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Lf/g;->p(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Lf/g;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Lf/g;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Lf/g;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Lf/g;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Lf/g;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Lf/g;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/b0;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Lf/g;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Lf/g;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Lf/g;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/u;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Lf/g;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Lf/g;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/z;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Lf/g;->u(Landroid/view/View;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_b
    invoke-virtual {p0, p1, p4}, Lf/g;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Lf/g;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Lf/g;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t;
    ...
    invoke-direct {p0, p1, p2, p4}, Lf/g;->s(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p5, p4}, Lf/g;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
